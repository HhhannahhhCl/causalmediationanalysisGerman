...
def save_figures(data, source, model_version, filter, suffix, k=10):
    ...
    plt.yticks(size=10)
    p3 = plt.axhline(data['mean_total_effect'][0], linestyle='--')
    ...
    for do_sort in False, True:
        for effect_type in ('indirect', 'direct'):
            ...
            elif model_version in ('gpt2', 'gpt2_random', 'gpt2larger', 'gerpt2'):
            ...
            cbar = plt.colorbar(ax1.get_children()[0], cax=cax, orientation='vertical') # Colorbar
