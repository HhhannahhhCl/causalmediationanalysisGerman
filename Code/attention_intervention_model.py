...
class AttentionOverride(nn.Module):
    ...
    def __init__(self, attention, attn_override, attn_override_mask, gpt2_config):
        """
        Args:
        ...
        self.output_attentions = gpt2_config.output_attentions
        self.register_buffer("bias", attention._buffers["bias"])
        self.n_head = gpt2_config.n_head  # attention.n_head
        self.split_size = attention.split_size
        self.scale = gpt2_config.scale_attn_weights # attention.scale
    ...
    def _attn(self, q, k, v, attention_mask=None, head_mask=None):
        ...
        w = w * b - 1e4 * ~b # (1 - b) # due to newer torch version
